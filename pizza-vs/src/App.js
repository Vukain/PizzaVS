...
function App() {
  ...
  useEffect(() => {
    ...
    // const dough = elementsPizza.getElementById('pizzas_svg__Dough');
    // const sauce = elementsPizza.getElementById('pizzas_svg__Sauce');
    // const cheese = elementsPizza.getElementById('pizzas_svg__Cheese');

    const parma = document.getElementById('pizzas_svg__parma');
    const formaggi = document.getElementById('pizzas_svg__formaggi');

    // const prosciuttos = elementsPizza.querySelectorAll('[data-name= "pizzas_svg__Prosciutto A"], [data-name= "pizzas_svg__Prosciutto B"]');
    // const tomatos = elementsPizza.querySelectorAll('[data-name= "pizzas_svg__Tomato Small"]');
    // const rucola = elementsPizza.querySelectorAll('[data-name= "pizzas_svg__Rucola A"], [data-name= "pizzas_svg__Rucola B"], [data-name= "pizzas_svg__Rucola C"]');
    // const olives = elementsPizza.querySelectorAll('[data-name= "pizzas_svg__Black Olive A"], [data-name= "pizzas_svg__Black Olive B"]');
